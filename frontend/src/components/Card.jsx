...
const Card = ({ imageSrc, altText, testimonial, customerName }) => {
  return (
    <div className="bg-stone-50 rounded-xl shadow-sm overflow-hidden flex flex-col items-center max-w-md mx-auto w-full">
      <div className="w-full px-4 sm:px-6 py-4 bg-green-100">
        <img className="w-16 h-16 rounded-full" src={imageSrc} alt={altText} />
      </div>
      <div className="w-full p-4 sm:p-8 rounded-2xl flex flex-col items-start gap-4 sm:gap-6">
        <svg
          width="32"
          height="32"
          viewBox="0 0 40 40"
        ...
        <div className="text-zinc-800 text-base sm:text-lg font-medium leading-relaxed">
          {testimonial}
        </div>

        <div className="text-neutral-400 text-base sm:text-lg font-semibold leading-relaxed">
          — {customerName}
        </div>
      </div>
    </div>
